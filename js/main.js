...
// Alle Layer laden
Promise.all([
  loadGeoJSON("Daten/Potenzialflächen/pot_800.geojson"),
  loadGeoJSON("Daten/Potenzialflächen/pot_1000.geojson"),
  loadGeoJSON("Daten/Potenzialflächen/pot_top15.geojson"),
  loadGeoJSON("Daten/Bestandsanlagen/bestehende_WEA_NF.geojson")
])
.then(([pot800Data, pot1000Data, top15Data, weaData]) => {
